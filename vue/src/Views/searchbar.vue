      ...
      <div class="row search-type">
        <div class="col-md-12">
          <label class="radio-inline">
            <input type="radio" v-model="type"  value="ojibwe">
            Search in Ojibwe
          </label>
          <label class="radio-inline">
            <input type="radio" v-model="type"  value="english">
            Search in English
          </label>
          <label class="radio-inline">
            <input type="radio" v-model="type"  value="collections">
...
export default {
  ...
  methods: {
    submit(){
      var self  = this;
       this.$router.replace(`/search?utf8=%E2%9C%93&q=${self.q}&commit=Search&type=${self.type}`);
    }
  }
}
</script>
